...
def default_crowdhuman_scheduler(epochs=50, decay_epochs=40, warmup_epochs=0):
    """
    ...
    """
    # total number of iterations assuming 16 batch size, using 1440000/16=90000
    total_steps_4bs = epochs * 937
    decay_steps = decay_epochs * 937
    warmup_steps = warmup_epochs * 937
    scheduler = L(MultiStepParamScheduler)(
        values=[1.0, 0.1],
        milestones=[decay_steps, total_steps_4bs],
    )
    return L(WarmupParamScheduler)(
        scheduler=scheduler,
        warmup_length=warmup_steps / total_steps_4bs,
        warmup_method="linear",
        warmup_factor=0.001,
    )
...
lr_multiplier_50ep = default_crowdhuman_scheduler(50, 40, 0)
lr_multiplier_36ep = default_crowdhuman_scheduler(36, 30, 0)
lr_multiplier_24ep = default_crowdhuman_scheduler(24, 20, 0)
lr_multiplier_12ep = default_crowdhuman_scheduler(12, 11, 0)
lr_multiplier_15ep = default_crowdhuman_scheduler(15, 10, 0)
