...
plt.colorbar()
plt.legend()
plt.title(f't-SNE Visualization of {model_type} Features with Legend')
plt.show()
plt.savefig(f'{model_type}_tsne.jpg')
plt.close()
...
# plt.colorbar()
# plt.legend()
# plt.title(f'UMAP Visualization of {model_type} Features with Legend')
# plt.show()
# plt.savefig(f'{model_type}_umap.jpg')
# plt.close()